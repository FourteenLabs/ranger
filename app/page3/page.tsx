...
const PACK: PackMember[] = [
  {
    ...
    desc: "Ziba was my Labrador for 14.5 incredible years. She was the clearest example of what a truly right match looks like and losing her is what set everything in motion.",
    src: "/ZibaHeadShot-18.jpg",
  },
  {
    name: "Ranger",
    trait: "The Foster Who Proved the Problem",
    desc: "Ranger came to us as a foster and stayed for 3 months. Four families wanted him, none were the right fit. His fifth match was perfect. That moment made it impossible to ignore how broken the system was.",
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-cta-row   { animation: fadeUp 0.8s 0.80s both; }
        ...
        .stats-grid   { display: grid; grid-template-columns: repeat(3,1fr); max-width: 1200px; margin: 0 auto; }
        .stat-cell    { padding: 24px 40px; border-right: 1px solid rgba(253,246,236,0.1); }
        ...
        @media (max-width: 900px) {
          ...
          .stat-cell:nth-child(3) { border-right: none; border-top: 1px solid rgba(253,246,236,0.1); grid-column: 1 / -1; }
        }
        ...
        @media (max-width: 640px) {
          ...
          .stat-cell      { border-right: none !important; border-top: none; border-bottom: 1px solid rgba(253,246,236,0.1); padding: 20px 0; }
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            background: "var(--mist)", padding: "7px 16px", borderRadius: 100,
            whiteSpace: "nowrap",
          }}>
            Coming Soon
          </span>
      ...
      <section aria-label="Hero" style={{
        ...
        <p className="hero-eyebrow" style={{
          ...
          textTransform: "uppercase", color: "var(--amber)", marginBottom: 22,
        }}>
        ...
        <p className="hero-valueprop" style={{
          ...
          marginTop: 24, marginBottom: 16, maxWidth: 680,
        }}>
        ...
        <div className="hero-cta-row" style={{
          ...
          {heroSuccess ? (
            ...
            <>
              ...
              />
              <div style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 14, color: "var(--bark-light)" }}>
                <div style={{ display: "flex" }}>
                  {["🐶","🐕","🦮"].map((e, i) => (
                    <span key={i} style={{
                      width: 32, height: 32, borderRadius: "50%",
                      border: "2px solid var(--cream)", background: "var(--mist)",
                      marginLeft: i === 0 ? 0 : -8,
        ...
        <Reveal>
          <div style={{
            ...
            <p style={{
              ...
              That&rsquo;s me and Ziba. She was my Labrador for 14.5 years and she
              was the clearest example I&rsquo;ve ever seen of what a truly right match
              looks like. When we lost her, we started fostering to fill the void.
            </p>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                <div style={{
                  fontFamily: "var(--font-playfair), serif",
                  fontSize: 17, fontWeight: 700, color: "var(--bark)",
                }}>Ali, Founder</div>
                <div style={{ fontSize: 13, color: "var(--bark-light)", opacity: 0.6 }}>
      ...
      {/* ── STATS STRIP ─────────────────────────────────────────── */}
      <div role="region" aria-label="Adoption statistics" style={{
        background: "var(--bark)",
      ...
      {/* ── MARQUEE ─────────────────────────────────────────────── */}
      <div aria-hidden="true" style={{
        background: "var(--amber)", padding: "18px 0",
            ...
            {STEPS.map((step, i) => (
              <Reveal key={i} delay={i * 120}>
                ...
                >
                  ...
                  <span style={{ fontSize: 36, display: "block", marginBottom: 18 }}>
                    {step.icon}
                  </span>
                  <div style={{
      ...
      {/* ── MISSION ─────────────────────────────────────────────── */}
      <section aria-label="Our mission" style={{ padding: "clamp(80px, 10vw, 120px) 0" }}>
        <div className="section-inner">
          <div className="mission-grid">
            ...
            <Reveal>
              <div>
                <div style={{
                  ...
                  lineHeight: 1, position: "relative", userSelect: "none",
                }}>
                  15%
                  <span style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Ziba — 14.5 years of the perfect match.
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={180}>
              <div>
                ...
                <p style={{
                  fontSize: "clamp(15px, 1.5vw, 18px)", fontWeight: 300,
      ...
      <section aria-label="Join the waitlist" style={{
        ...
        <div style={{
          ...
          <Reveal delay={160}>
            <p style={{
              fontSize: "clamp(16px, 1.6vw, 20px)", fontWeight: 300,
              ...
              and be part of a movement that changes how dogs find homes furever.
            </p>
          </Reveal>
          <Reveal delay={240}>
            {waitlistSuccess ? (
              ...
              <div style={{
                ...
                />
                <p style={{
                  fontSize: 13, color: "rgba(253,246,236,0.3)", letterSpacing: "0.4px",
                }}>
      ...
      <footer style={{
        ...
        <div className="footer-inner">
          <span style={{
            fontFamily: "var(--font-playfair), serif",
            fontSize: 20, fontWeight: 700, color: "var(--bark)",
          }}>
            Fetch<span style={{ color: "var(--amber)" }}>My</span>Heart
          </span>
          <p style={{ fontSize: 13, color: "var(--bark-light)", opacity: 0.5 }}>
