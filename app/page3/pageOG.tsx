...
const PACK: PackMember[] = [
  {
    ...
    desc: "Ziba was a Labrador who lived 14.5 incredible years. She was the dog who showed us what a truly right match looks like — and losing her is what set everything in motion.",
  ...
  },
  {
    ...
    desc: "Ranger came to us as a foster and stayed for 3 months. Four families wanted him. None were the right fit. His fifth match? Perfect. That moment made it impossible to ignore how broken the system was.",
...
// ─────────────────────────────────────────────────────────────
// Email capture — wired to Formspree
// ─────────────────────────────────────────────────────────────
function EmailCapture({
  ...
  async function submit() {
    ...
    if (!trimmed || !trimmed.includes("@")) {
      // Shake the input — quick inline visual feedback
      setStatus("error");
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Formspree returns structured errors — surface them gracefully
        setStatus("error");
  ...
  // Border colour signals state
  const wrapBorder = isError
    ? "1px solid rgba(196,105,75,0.7)"   // clay-red for error
    : dark
    ? "1px solid rgba(253,246,236,0.18)"
    : "none";
...
export default function FetchMyHeartPage() {
  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .founder-photo-fade {
            background: linear-gradient(to bottom, transparent 50%, var(--cream) 100%) !important;
          }
        }
      ...
      {/* ════════════════════════════════════════════
          FOUNDER PHOTO — Ali & Ziba at sunset
      ════════════════════════════════════════════ */}
      <section
        aria-label="The story behind FetchMyHeart"
        style={{
          display: "grid",
      ...
      >
        ...
        <div style={{ position: "relative", overflow: "hidden" }}>
          <Image
            ...
            priority
          />
          {/* Subtle fade into the copy panel — right on desktop, bottom on mobile */}
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                <div style={{
                  fontFamily: "var(--font-playfair), serif",
                  fontSize: 15, fontWeight: 700, color: "var(--bark)",
                }}>Ali, Founder</div>
                <div style={{
                  fontSize: 12, color: "var(--bark-light)", opacity: 0.6,
                }}>Ziba&rsquo;s person, forever 🐾</div>
              </div>
            </div>
          </div>
        </Reveal>
